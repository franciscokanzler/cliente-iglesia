...
<div {{$attributes->merge(['class'=>'col-10 col-sm-6 col-md-5 col-lg-3 col-xl-3 mx-lg-4 px-md-4 px-lg-4 px-xl-4 px-xxl-4'])}}>
    <div class="card bg-gradient-marron-claro" {{-- style="background-color: #d2c6c18f;" --}}>
        <div class="card-body pt-0 p-3 text-center">
            {{$boton}}
            <h6 class="text-center text-light text-gradient mb-0">{{$modulo}}</h6>
            <hr class="horizontal dark my-2" style="height: 2px;">
            <span class="text-xs text-light text-gradient">{{$dato}}</span>
