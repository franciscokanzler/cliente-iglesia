<div>
    <main class="main-content">
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <x-opcion_menu_admin class="mt-xxl-6" modulo="Iglesia" dato="nombre o nro">
                    <x-slot name="boton">
                        <x-boton_menu wire:click="opcion(1)" title="Home" class="btn-admin bg-gradient-info" nombreIcono="fa-solid fa-landmark"/>
                    </x-slot>
                </x-opcion_menu_admin>
                <x-opcion_menu_admin class="mt-4 mt-md-0 mt-xxl-6" modulo="Miembros" dato="nro">
                    <x-slot name="boton">
            ...
            <div class="row mb-4">
                <x-opcion_menu_admin class="mt-xxl-6" modulo="Equipos" dato="nro">
                    <x-slot name="boton">
                        <x-boton_menu wire:click="opcion(1)" title="Home" class="btn-admin bg-gradient-info" nombreIcono="fa-solid fa-people-group"/>
                    </x-slot>
                </x-opcion_menu_admin>
                <x-opcion_menu_admin class="mt-4 mt-md-0 mt-xxl-6" modulo="Rangos" dato="nro">
                    <x-slot name="boton">
                        <x-boton_menu wire:click="opcion(1)" title="Home" class="btn-admin bg-gradient-info" nombreIcono="fa-solid fa-diagram-project"/>
                    </x-slot>
                </x-opcion_menu_admin>
            </div>
            {{-- <div class="row">
